...
class Question {
    ...
    static let originalQuestions = [
        ...
        Question("<HRAC>, co je nejoblíbenější alkoholický nápoj <SOUPER>?", needsOpponent: true),
        ...
        Question("<HRAC>, který hráč je nejmenší?"),
        Question("<HRAC>, který hráč je nejvyšší?"),
        ...
        Question("<HRAC>, kdo z hráčů je vegetarián/vegan?"),
        ...
        Question("<HRAC>, přeběhni místnost tam a zpátky a přitom volej \"Run Forrest, run!\"", difficulty: 3),
        ...
        Question("<SOUPER> řekne jednu pravdu a jednu lež. <HRAC>, uhádni co byla pravda", difficulty: 3, needsOpponent: true),
        ...
        Question("<HRAC>, vymysli přezdívku pro ostatní hráče"),
        Question("<HRAC>, popiš všechny ostatní hráče (dohromady) pomocí jednoho slova", difficulty: 1),
        Question("<HRAC>, prones proslov na počest své firmy se silným francouzským přízvukem", difficulty: 1),
        ...
        Question("<HRAC>, řekni abecedu pozpátku do 30 sekund", difficulty: 3),
