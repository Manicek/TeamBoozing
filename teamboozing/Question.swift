...
class Question {
    ...
    static let silvesterQuestions = [
        ...
        Question("co nejdivnějšího jsi při sexu dělal/a?", difficulty: 3),
        ...
        Question("vypij panáka kterého ti vytvoří a namíchají ostatní", difficulty: 4),
        Question("nech ostatní hráče, aby ti napsali fixem něco na tělo", difficulty: 3),
        Question("nech ostatní hráče, aby ti udělali jakýkoliv účes"),
        Question("breakdancuj 30 sekund"),
        Question("dej osobě po levici pusu"),
        Question("předveď červa, na zemi"),
        Question("pokus se o kouzelnický trik"),
        Question("vyměň si oblečení s někým ve skupině na další 3 kola"),
        Question("přejdi z jednoho konce pokoje na druhý po rukou, někdo ti může chytit nohy"),
        Question("ptáčejte kolem sebe imaginarní hula hop po 2 kola"),
        Question("tancuj na celou písničku podle výběru ostatních"),
        Question("běž na záchod, sundej si trenky/kalhotky a nos je na hlavě až do konce hry", difficulty: 5),
        Question("sněz 15 SECALO do 30 sekund, bez zapíjení"),
        Question("sundej si tričko", difficulty: 4),
        ...
        Question("řekni, kterému hráči podle tebe nejvíc smrdí nohy"),
        // MARK: Needs Opponent
